...
const faqs = [
  { q: "How much does pipe repair cost in Providence RI?", a: "Costs vary widely depending on location and extent. A simple accessible joint repair may cost $150–$350. Leak detection plus repair of a hidden leak typically runs $350–$800. A section replacement in a finished wall can run $500–$1,500 including drywall patching. Full home repiping starts around $4,500 for smaller homes. We provide free, detailed written estimates." },
